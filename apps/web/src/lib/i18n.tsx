...
const zhCN: Dictionary = {
  ...
  "knowledge.refine": "AI 提炼速览",
  "knowledge.group.manual": "人工沉淀",
  "knowledge.group.run": "运行自动沉淀",
  "knowledge.group.ai": "AI 提炼",
  "agents.edit": "编辑",
  "workflow.title": "工作流编排",
  "workflow.subtitle": "编辑团队接力流程:每一步用哪个智能体、继承哪些上一步产出。",
  "workflow.edit": "编辑工作流",
  "workflow.feedFrom": "继承",
  "team.backList": "返回团队列表",
  "team.backProcess": "返回流程",
  "team.participants": "参与者",
  "team.progress": "进度",
  "team.results": "结果汇总",
  "team.recent": "近期团队",
  "team.newRelay": "发起新接力",
...
const enUS: Dictionary = {
  ...
  "common.nav.workflows": "Workflows",
  ...
  "knowledge.refine": "AI refine brief",
  "knowledge.group.manual": "Curated by you",
  "knowledge.group.run": "Auto-deposited from runs",
  "knowledge.group.ai": "AI-refined",
  "agents.edit": "Edit",
  "workflow.title": "Workflow Editor",
  "workflow.subtitle": "Edit team relays: which agent per step, and which prior outputs it inherits.",
  "workflow.edit": "Edit workflow",
  "workflow.feedFrom": "inherits",
  "team.backList": "Back to teams",
  "team.backProcess": "Back to pipeline",
